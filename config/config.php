...
$config['view']['name']        = 'TezClubInternational';                   // название сайта
$config['view']['description'] = 'TezClubInternational - социальная сеть ценителей отдыха.'; // seo description
 ...
 */
$config['block']['stream']['row'] = 5;  // сколько записей выводить в блоке "Прямой эфир"
...
$config['sys']['session']['name']     = 'tezclub';                      // название сессии
...
$config['sys']['mail']['from_name']        = 'TezClubInternational';  // Имя с которого отправляются все уведомления
...
$config['module']['blog']['encrypt']         = 'tezclub'; // Ключ XXTEA шифрования идентификаторов в ссылках приглашения в блоги
...
$config['module']['talk']['encrypt']    = 'tezclub'; // Ключ XXTEA шифрования идентификаторов в ссылках
// Модуль Lang
