<ul class="menu">
	<li {if $sMenuItemSelect=='index'}class="active"{/if}>
		<a href="{cfg name='path.root.web'}/" class="blue">{$aLang.blog_menu_all}</a> {if $iCountTopicsNew>0}<a href="{router page='new'}" class="new">{$iCountTopicsNew}</a>{/if}
		{if $sMenuItemSelect=='index'}
			<ul class="sub-menu">
				...
				{if $iCountTopicsNew>0}<li {if $sMenuSubItemSelect=='new'}class="active"{/if}><a href="{router page='new'}">{$aLang.blog_menu_all_new}</a> <span class="counter">{$iCountTopicsNew}</span></li>{/if}
	...
	<li {if $sMenuItemSelect=='blog'}class="active"{/if}>
		<a href="{router page='blog'}" class="blue">{$aLang.blog_menu_collective}</a> {if $iCountTopicsCollectiveNew>0}<a href="{router page='blog'}new/" class="new">{$iCountTopicsCollectiveNew}</a>{/if}
		{if $sMenuItemSelect=='blog'}
			<ul class="sub-menu">
				<li {if $sMenuSubItemSelect=='good'}class="active"{/if}><a href="{$sMenuSubBlogUrl}">{$aLang.blog_menu_collective_good}</a></li>
				{if $iCountTopicsBlogNew>0}<li {if $sMenuSubItemSelect=='new'}class="active"{/if}><a href="{$sMenuSubBlogUrl}new/">{$aLang.blog_menu_collective_new}</a> <span class="counter">{$iCountTopicsBlogNew}</span></li>{/if}
	...
	<li {if $sMenuItemSelect=='log'}class="active"{/if}>
		<a href="{router page='personal_blog'}" class="blue">{$aLang.blog_menu_personal}</a> {if $iCountTopicsPersonalNew>0}<a href="{router page='personal_blog'}new/" class="new">{$iCountTopicsPersonalNew}</a>{/if}
		{if $sMenuItemSelect=='log'}
			<ul class="sub-menu">
				...
				{if $iCountTopicsPersonalNew>0}<li {if $sMenuSubItemSelect=='new'}class="active"{/if}><a href="{router page='personal_blog'}new/">{$aLang.blog_menu_personal_new}</a> <span class="counter">{$iCountTopicsPersonalNew}</span></li>{/if}
	...
	<li {if $sMenuItemSelect=='top'}class="active"{/if}>
		<a href="{router page='top'}" class="blue">{$aLang.blog_menu_top}</a>
